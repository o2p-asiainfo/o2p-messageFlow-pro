...
import com.ailk.o2p.messageFlow.utils.CustomObjectUtils;
...
public final class JedisUtils {
	...
	public static final String KEY_PREFIX = "o2p";
	...
	public static String get(String key) {
		...
		try {
			...
			if (jedis.exists(key)) {
				value = jedis.get(key);
				value = CustomStringUtils.isNotBlank(value)
		...
		try {
			...
			if (jedis.exists(getBytesKey(key))) {
				...
				for (Map.Entry<byte[], byte[]> e : map.entrySet()) {
					value.put(CustomStringUtils.toString(e.getKey()),
							toObject(e.getValue()));
				}
	...
	public static byte[] getBytesKey(Object object) {
		if (object instanceof String) {
			return CustomStringUtils.getBytes((String) object);
		} else {
			return CustomObjectUtils.serialize(object);
		}
	}
	...
	public static Object toObject(byte[] bytes) {
		return CustomObjectUtils.unserialize(bytes);
	}
